...
def main():
    alumno = Alumno()
    alumno.setNombre("Johan")
    alumno.setApellidos("Fiallo Aparicio")
    alumno.setEdad(14)
    ...
    profesor.setEdad(25)
    profesor.setAntiguedad("5 años")
    profesor.setTutorias(["Matemáticas de 12:30 a 2:30", "Tecnología 2:40 a 4:40", "Inglés de 5:00 a 6:45"])
    profesor.setTelefono("313558758")
